...
class BugReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug_report" do
    assert_difference("BugReport.count") do
      post bug_reports_url, params: { bug_report: { body: @bug_report.body, email: @bug_report.email, name: @bug_report.name, subject: @bug_report.subject, user_id: @bug_report.user_id } }
    end
  ...
  test "should update bug_report" do
    patch bug_report_url(@bug_report), params: { bug_report: { body: @bug_report.body, email: @bug_report.email, name: @bug_report.name, subject: @bug_report.subject, user_id: @bug_report.user_id } }
